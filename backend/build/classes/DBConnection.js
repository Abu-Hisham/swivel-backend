...
const dbconnection = sql['connect']({
    ...
    if (error) {
        ...
        // console.log(usr.register("Abdulaziz","Mohd","Rajab","0701633086","abduli@ekenya.co.ke", "Kenya","13-06-1993", "M", "Kenyan","31672610","Zizahry@123", "Zizahry@123"));
        console.log(usr.login("0701633018", "Zizahry@123"));
